...
// // 'add_mic_record_voice_icon_48', 48x48px
// const uint8_t mic_icon[] PROGMEM = {
//   0x00, 0x00, 0x07, 0xe0, 0x00, 0x00, 0x00, 0x00, 0x1f, 0xf8, 0x00, 0x00, 0x00, 0x00, 0x7f, 0xfe,
...
//   0x00, 0x03, 0xff, 0xff, 0xc0, 0x00, 0x00, 0x03, 0xff, 0xff, 0xc0, 0x00, 0x00, 0x03, 0xff, 0xff,
//   0xc0, 0x00, 0x00, 0x03, 0xff, 0xff, 0xc0, 0x00, 0x07, 0x83, 0xff, 0xff, 0xc1, 0xe0, 0x0f, 0xc3,
//   0xff, 0xff, 0xc3, 0xf0, 0x0f, 0xc3, 0xff, 0xff, 0xc3, 0xf0, 0x0f, 0xc3, 0xff, 0xff, 0xc3, 0xf0,
//   0x0f, 0xc3, 0xff, 0xff, 0xc3, 0xf0, 0x0f, 0xc1, 0xff, 0xff, 0x83, 0xf0, 0x0f, 0xc1, 0xff, 0xff,
//   0x83, 0xf0, 0x0f, 0xc0, 0xff, 0xff, 0x07, 0xf0, 0x0f, 0xe0, 0xff, 0xff, 0x07, 0xe0, 0x07, 0xe0,
//   0x7f, 0xfe, 0x07, 0xe0, 0x07, 0xf0, 0x1f, 0xf8, 0x0f, 0xe0, 0x07, 0xf0, 0x07, 0xe0, 0x0f, 0xc0,
//   0x03, 0xf8, 0x00, 0x00, 0x1f, 0xc0, 0x03, 0xfc, 0x00, 0x00, 0x3f, 0xc0, 0x01, 0xfe, 0x00, 0x00,
//   0x7f, 0x80, 0x01, 0xff, 0x00, 0x00, 0xff, 0x00, 0x00, 0xff, 0xc0, 0x03, 0xff, 0x00, 0x00, 0x7f,
//   0xf0, 0x0f, 0xfe, 0x00, 0x00, 0x3f, 0xff, 0xff, 0xfc, 0x00, 0x00, 0x1f, 0xff, 0xff, 0xf8, 0x00,
//   0x00, 0x0f, 0xff, 0xff, 0xe0, 0x00, 0x00, 0x03, 0xff, 0xff, 0xc0, 0x00, 0x00, 0x00, 0xff, 0xff,
...
void __oled_userscreen_recording_start() {
  ...
  // icon
  // __display->drawBitmap(0, 0, mic_icon, 48, 48, WHITE);

  //frame
  // __display->drawRect(0, 0, 128, 64, WHITE);
  __display->drawRoundRect(0, 0, 128, 64, 5, WHITE);
  ...
  //
  __display->setCursor(12,38);
  __oled_date(year(__local), month(__local), day(__local));
  __display->println();

  //
  __display->setCursor(12,48);
  __oled_time(hour(__local), minute(__local), second(__local));
  __display->println();
